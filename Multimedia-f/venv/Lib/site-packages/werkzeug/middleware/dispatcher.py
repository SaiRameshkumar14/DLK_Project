...
This example dispatches to an API Frontend under "/api", an admin Frontend
under "/admin", and an Frontend that serves frontend files for all other
requests::

    Frontend = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
